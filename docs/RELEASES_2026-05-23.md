...
Physischer Touch-, Buzzer- und Runddisplay-Sichttest stehen noch aus.

Aktuelle WebGUI des geflashten Kandidaten:

![M5Dial WebGUI mit ADV, T/V, Settings und gesperrter Tune-Seite](assets/webgui-v0.3.0-ui-candidate.png)
...
| Aktion | Funktion |
| --- | --- |
| Encoder kurz druecken | Naechste Display-Seite |
| Display antippen | Naechste Display-Seite |
| Long-Press auf `ADV` oder `T/V` | Read-only Kurvenabruf |
| Drehen in `SETTINGS` | Einstellung auswaehlen |
| Long-Press in `SETTINGS` | Einstellung schalten / Helligkeit wechseln |
...
- Touch-Seitenwechsel und Buzzer-Einstellungen am Geraet testen.
